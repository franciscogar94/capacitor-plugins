...
export class GoogleMap {
  ...
  async removeAllMarkers(): Promise<void> {
    return CapacitorGoogleMaps.removeAllMarkers({
      id: this.id,
    });
  }
  ...
  */
  ...
  Directions(args: {
    ...
    return this.getDirectionsResult(args.origin, args.destination)
      .then(async result => {
        return await CapacitorGoogleMaps.handlerDirections({
          id: this.id,
          result:
  ...
  /**Remove all polylines generated by the method Directions*/
